...
<svelte:head>
	...
	<link rel="preconnect" href="https://cdn.netders.com" />
	...
	<script type="text/partytown" src="https://www.googletagmanager.com/gtag/js?id=G-N12QC6M7CQ"></script>
	...
	<footer>
		<div class="hidden bg-white rounded-lg shadow-md mt-4 p-4 lg:p-8 invite-friend-background lg:text-xl flex flex-col lg:flex-row items-center gap-4 text-center lg:text-left lg:justify-between">
			<div>
				...
				<br />
				<span class="text-xs">Arkadaşının üye olup, ilk geçerli siparişinde indirim kuponu hesabına tanımlanır.</span>
			</div>
			<div>
		...
		<section class="shadow-md rounded-t-lg bg-white text-center text-base my-4">
			<div class="p-6 text-gray-500 text-sm">
				Copyright © 2013 - 2023 Netders.com
			</div>
