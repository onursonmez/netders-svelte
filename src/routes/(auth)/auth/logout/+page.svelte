...
<div class="flex text-center h-screen my-auto items-center justify-center">
    <div>
        <div class="mt-2 text-7xl font-bold">Good bye!</div>
        <img src="{Bye}" width="300" class="mx-auto my-12">
        <div class="text-2xl font-bold">Hesabından başarıyla çıkış yaptın.</div>
        <div class="mt-2">En yakın zamanda tekrar görüşmek dileğiyle.</div>
