...
<svelte:head>
	...
	{#if pageData.level?.title || $page.url.searchParams.get('page') || $page.url.searchParams.get('amp') || $page.url.searchParams.get('sort_point') || $page.url.searchParams.get('sort_price')}
