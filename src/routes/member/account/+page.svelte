                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <div class="lg:col-span-2">
                            <label>
                                <input type="checkbox" bind:checked={accountModel.outsideTurkey} class="rounded-sm ring-0 outline-none" /> <span class="text-gray-500 text-sm">Türkiye'de yaşamıyorum</span>
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-6">
                ...
                <div class="grid lg:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input name="currentEmail" type="text" bind:value="{accountModel.email}" class="ring-0 w-full rounded-md border border-gray-300 hover:border-gray-400 focus:border-blue-600 focus:ring-0" disabled />
                    </div>
                    <div>
