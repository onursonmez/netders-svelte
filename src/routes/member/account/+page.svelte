        ...
        >
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 gap-4 mt-4">
                    ...
                    <div>
                        <span class="text-sm mb-1 block text-gray-500">İptal nedeni</span>
                        <textarea name="reason" class="ring-0 w-full rounded-md border border-gray-300 hover:border-gray-400 focus:border-blue-600 focus:ring-0"></textarea>
                    </div>
                </div>
            </div>
            <div class="bg-[#fbfcff] border-t border-gray-100 p-6 rounded-b-lg text-right">
                ...
                {:else}
                    <button class="bg-red-700 hover:bg-red-900 px-6 py-2 rounded-full text-white">
                        Üyeliğimi iptal et
                    </button>
                {/if}
            </div>
