                    ...
                    {:else}
                        ...
                        >
                            <div class="p-4 border border-gray-100 rounded-b-lg text-sm">
                                <button name="teacherId" value="{requestTeacher.uuid}" class="flex gap-2 bg-blue-700 hover:bg-blue-900 text-white items-center p-2 px-4 rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    Öğretmeni Seç
                    ...
                    <div class="lg:flex lg:flex-row gap-2 bg-white p-6 rounded-lg shadow-md">
                        ...
                        <div class="lg:basis-9/12 xl:basis-10/12">
                            ...
                            >
                                ...
                                <input type="hidden" name="teacherId" value="{eligibleTeacher.uuid}" />
                                <input type="hidden" name="requestId" value="{request.uuid}" />
                            </form>
                        </div>
                    </div>
