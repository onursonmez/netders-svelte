<script>
    ...
    const handleSubmit = async () => {
        ...
        let response = await updateUser(pageData)
    ...
    onMount( async () => {
        ...
        const userResponse = await getUser($userStore.username)
...
<div class="flex gap-4 mt-4">
    ...
    <div class="grow bg-white rounded-lg shadow-md">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 gap-4">
                <div>
                    ...
                    <input placeholder="Seni veya uzmanlığını anlatan tek cümlelik bir bilgi yaz" maxlength="70" type="text" bind:value="{pageData.title}" class="ring-0 w-full block rounded-md border border-gray-300 hover:border-gray-400 focus:border-blue-600 focus:ring-0" />
                ...
                <div>
                    ...
                    <textarea maxlength="500" placeholder="Senin ve uzmanlığın hakkında detaylı bilgi yaz" rows="5" bind:value="{pageData.about}" class="ring-0 w-full block rounded-md border border-gray-300 hover:border-gray-400 focus:border-blue-600 focus:ring-0"></textarea>
        ...
        <div class="bg-[#fbfcff] border-t border-gray-100 p-6 rounded-b-lg text-right">
            ...
            {:else}
                <button on:click={() => handleSubmit()} class="bg-blue-700 hover:bg-blue-900 px-6 py-2 rounded-full text-white">
                    <span>Kaydet</span>
                </button>
            {/if}
        </div>
