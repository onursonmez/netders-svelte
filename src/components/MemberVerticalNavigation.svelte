...
<ul class="flex flex-col gap-1 text-sm">
    ...
    <li>
        <a href="/member/location" class="block p-2 hover:bg-white w-full rounded-md {$page.url.pathname === '/member/location' ? 'text-blue-700 bg-white hover:bg-white shadow-md' : ''}">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 inline-block">
    ...
    <li>
        <a href="/member/preference" class="block p-2 hover:bg-white w-full rounded-md {$page.url.pathname === '/member/preference' ? 'text-blue-700 bg-white hover:bg-white shadow-md' : ''}">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 inline-block">
    ...
    <li class="hidden">
        <a href="/member/comment" class="flex justify-between block p-2 hover:bg-white w-full rounded-md {$page.url.pathname === '/member/comment' ? 'text-blue-700 bg-white hover:bg-white shadow-md' : ''}">
            <span>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 inline-block">
