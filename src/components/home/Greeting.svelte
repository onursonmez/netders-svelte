		...
		<div class="mr-auto place-self-center lg:col-span-8">
			...
			<form autocomplete="off" on:submit|preventDefault={onSearch}>
				<div class="relative">
					...
					<input type="text" bind:value={keyword} id="default-search" class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 shadow-md rounded-lg border-0" placeholder="Aradığın özel ders nedir?">
			...
			<p class="text-xs text-gray-400 pt-2">Örneğin; matematik, ingilizce, fizik gibi, almak istediğin özel dersin adını yukarıdaki arama alanına girip, ara tuşuna bas.</p>
		</div>
