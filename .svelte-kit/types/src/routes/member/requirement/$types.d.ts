...
type RouteParams = {  }
type RouteId = '/member/requirement';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/member/requirement/+page.server.js').load>>>>>>;
