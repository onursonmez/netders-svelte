...
type LayoutRouteId = RouteId | "/" | "/[slug]" | "/auth/activation" | "/auth/forgot" | "/auth/login" | "/gizlilik-ilkeleri" | "/iletisim" | "/kullanim-kosullari" | "/member/about" | "/member/account" | "/member/location" | "/member/preference" | "/member/price" | "/member/request" | "/member/request/[uuid]" | "/member/requirement" | "/mesafeli-satis-sozlesmesi" | "/nasil-calisir" | "/ogretmen-ol" | "/ozel-ders/[slug]" | "/ozel-ders-ilanlari-verenler/[...catchall]" | "/ozel-ders-talebi-olustur/[...catchall]" | "/yardim" | null
