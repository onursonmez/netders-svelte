import { c as create_ssr_component, b as subscribe, d as add_attribute, h as add_classes, v as validate_component, e as escape } from "../../../chunks/index.js";
/* empty css                   */import { L as Logo } from "../../../chunks/netders-logo-blue.js";
import { I as IconUser } from "../../../chunks/icon-user.js";
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<header><nav class="${"shadow-md bg-white"}"><div class="${"mx-auto max-w-[90%]"}"><div class="${"relative flex h-16 items-center justify-between"}"><div class="${"absolute inset-y-0 left-0 flex items-center lg:hidden"}">
				...
				<div class="${"absolute inset-y-0 right-0 flex items-center lg:static lg:inset-auto lg:ml-6 lg:pr-0"}"><button type="${"button"}" class="${"hidden rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"}"><span class="${"sr-only"}">View notifications</span>
					...
					<div class="${"relative ml-3"}"><div>${$userStore.username ? `<button type="${"button"}" class="${"flex rounded-full text-sm"}" id="${"user-menu-button"}" aria-expanded="${"false"}" aria-haspopup="${"true"}"><span class="${"sr-only"}">Open user menu</span>
    ...
    "hidden"
								...
								<a href="${"/logout"}" class="${"block px-4 py-2 text-sm text-gray-700"}" role="${"menuitem"}" tabindex="${"-1"}" id="${"user-menu-item-2"}">G\xFCvenli \xC7\u0131k\u0131\u015F</a></div>` : ``}</div></div></div></div>
