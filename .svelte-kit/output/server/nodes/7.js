import * as shared from '../entries/pages/(app)/member/about/_page.js';

export const index = 7;
export const component = async () => (await import('../entries/pages/(app)/member/about/_page.svelte.js')).default;
export const file = '_app/immutable/components/pages/(app)/member/about/_page.svelte-cc205ab1.js';
export { shared };
