import * as shared from '../entries/pages/(auth)/auth/forgot/_page.js';

export const index = 14;
export const component = async () => (await import('../entries/pages/(auth)/auth/forgot/_page.svelte.js')).default;
export const file = '_app/immutable/components/pages/(auth)/auth/forgot/_page.svelte-2d90f8b7.js';
export { shared };
